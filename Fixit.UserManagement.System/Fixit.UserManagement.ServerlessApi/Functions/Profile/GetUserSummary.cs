...
namespace Fixit.User.Management.ServerlessApi.Functions.Profile
{
  public class GetUserSummary : AzureFunctionRoute
  {
    ...
    [OpenApiResponseWithBody(HttpStatusCode.OK, "application/json", typeof(UserSummaryResponseDto))]
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "{id:Guid}/account/profile/summary")]
