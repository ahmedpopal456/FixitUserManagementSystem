...
{
  public class FakeUserRatingsDtoSeeder : IFakeSeederAdapter<RatingsDto>
  {
    public IList<RatingsDto> SeedFakeDtos()
    {
      RatingsDto firstRatingsRequest = new RatingsDto
      {
      ...
      RatingsDto secondRatingsRequest = null;
