...
namespace Fixit.User.Management.Lib.UnitTests.Mediators
{
    ...
    public class UserMediatorTests : TestBase
    {
        ...
        public void TestInitialize()
        {
            ...
            var fakeUserAccountCreateRequestDtoSeeder = _fakeDtoSeedFactory.CreateFakeSeeder<UserAccountCreateRequestDto>();
            var fakeUserAccountStateUpdateRequestDtoSeeder = _fakeDtoSeedFactory.CreateFakeSeeder<UserAccountStateDto>();
            var fakeUserAccountPasswordResetRequestDtoSeeder = _fakeDtoSeedFactory.CreateFakeSeeder<UserAccountResetPasswordRequestDto>();
            ...
            _fakeUserAccountCreateRequestDtos = fakeUserAccountCreateRequestDtoSeeder.SeedFakeDtos();
            _fakeUserAccountStateUpdateRequestDtos = fakeUserAccountStateUpdateRequestDtoSeeder.SeedFakeDtos();
            _fakeUserAccountResetPasswordeRequestDtos = fakeUserAccountPasswordResetRequestDtoSeeder.SeedFakeDtos();
